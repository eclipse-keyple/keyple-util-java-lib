| Version | Documents |
|:---:|---|
| 2.4.2-SNAPSHOT | [API documentation](2.4.2-SNAPSHOT)<br>[API class diagram](2.4.2-SNAPSHOT/api_class_diagram.svg) |
| **2.4.1 (latest stable)** | [API documentation](latest-stable)<br>[API class diagram](2.4.1/api_class_diagram.svg) |
